...
from Method_GCN_9 import Method_GCN
...
def run_one_dataset(dataset_name, data_folder, result_folder):
    ...
    # Model 9 Hyperparameters (Early Stopping)
    ...
    print("Model Version: Model 9 (Early Stopping)")
    ...
    model_path = os.path.join(
        ...
        f"{dataset_name}_gcn_model9.pth"
    )
...
def main():
    print("Stage 5: Graph Embedding and Node Classification with GCN - Model 9 (Early Stopping)")
