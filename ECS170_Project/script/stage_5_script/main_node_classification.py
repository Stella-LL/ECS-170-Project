...
def run_one_dataset(dataset_name, data_folder, result_folder):
    ...
    dataset_result_folder = os.path.join(result_folder, dataset_name)
    ...
    # Save model
    model_path = os.path.join(dataset_result_folder, f"{dataset_name}_gcn_model.pth")
...
def main():
    print("Stage 5: Graph Embedding and Node Classification with GCN")
