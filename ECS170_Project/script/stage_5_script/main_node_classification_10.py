...
from Method_GCN_10 import Method_GCN
...
def run_one_dataset(dataset_name, data_folder, result_folder):
    ...
    # Model 10 Hyperparameters (3-Layer GCN)
    ...
    print("Model Version: Model 10 (3-Layer GCN)")
    ...
    model_path = os.path.join(
        ...
        f"{dataset_name}_gcn_model10.pth"
    )
...
def main():
    print("Stage 5: Graph Embedding and Node Classification with GCN - Model 10 (3-Layer GCN)")
