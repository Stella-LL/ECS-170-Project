...
from Method_GCN_8 import Method_GCN
...
def run_one_dataset(dataset_name, data_folder, result_folder):
    ...
    # Model 8 Hyperparameters (BatchNorm)
    ...
    print("Model Version: Model 8 (BatchNorm)")
    ...
    model_path = os.path.join(
        ...
        f"{dataset_name}_gcn_model8.pth"
    )
...
def main():
    print("Stage 5: Graph Embedding and Node Classification with GCN - Model 8 (BatchNorm)")
