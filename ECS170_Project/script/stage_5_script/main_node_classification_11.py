...
def run_one_dataset(dataset_name, data_folder, result_folder):
    ...
    print("Model Version: Model 11 (Model 2 + Seed 0)")
    ...
    model_path = os.path.join(
        ...
        f"{dataset_name}_gcn_model11.pth"
    )
...
def main():
    print("Stage 5: Graph Embedding and Node Classification with GCN - Model 11 (Seed 0)")
