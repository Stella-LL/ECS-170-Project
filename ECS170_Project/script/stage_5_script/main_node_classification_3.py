...
from Method_GCN_3 import Method_GCN
...
def run_one_dataset(dataset_name, data_folder, result_folder):
    ...
    model_path = os.path.join(
        ...
        f"{dataset_name}_gcn_model3.pth"
    )
...
def main():
    print("Stage 5: Graph Embedding and Node Classification with GCN - Model 3")
