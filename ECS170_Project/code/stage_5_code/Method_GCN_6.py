...
class Method_GCN:
    ...
    def __init__(self, input_size, hidden_size=48, output_size=None, learning_rate=0.01, weight_decay=5e-4, epochs=200, dropout=0.5, device=None):
        ...
        print("=" * 60)
        print("GCN Model 6 Configuration")
