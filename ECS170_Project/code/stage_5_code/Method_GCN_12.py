...
class Method_GCN:
    ...
    def __init__(self, input_size, hidden_size=32, output_size=None, learning_rate=0.005, weight_decay=1e-3, epochs=300, dropout=0.3, device=None):
        ...
        print("=" * 60)
        print("GCN Model 12 Configuration (AdamW)")
