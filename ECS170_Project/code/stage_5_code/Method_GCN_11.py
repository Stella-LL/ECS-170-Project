...
class Method_GCN:
    ...
    def __init__(self, input_size, hidden_size=32, output_size=None, learning_rate=0.005, weight_decay=5e-4, epochs=300, dropout=0.3, device=None):
        ...
        print("=" * 60)
        print("GCN Model 11 Configuration (Model 2 + Seed 0)")
        print(f"Hidden Size: {hidden_size}")
        print(f"Learning Rate: {learning_rate}")
        print(f"Epochs: {epochs}")
        print(f"Dropout: {dropout}")
        print("Architecture: 2-Layer GCN")
        print("=" * 60)
