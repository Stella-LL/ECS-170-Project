...
class GCN_Node_Classifier(nn.Module):
    """
    Three-layer GCN model for node classification.
    ...
    def __init__(self, input_size, hidden_size, output_size, dropout=0.5):
        ...
        self.gcn_layer_1 = GCNLayer(input_size, 64)
        self.gcn_layer_2 = GCNLayer(64, 32)
        self.gcn_layer_3 = GCNLayer(32, output_size)
    ...
    def forward(self, x, adj):
        ...
        # Third GCN layer outputs class scores
        x = self.gcn_layer_3(x, adj)
...
class Method_GCN:
    ...
    def __init__(self, input_size, hidden_size=32, output_size=None,
                 ...
                 epochs=300, dropout=0.3, device=None):
        ...
        print("=" * 60)
        print("GCN Model 10 Configuration (3-Layer GCN)")
